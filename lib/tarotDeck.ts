...
export const TAROT_SPREAD_DECK: SpreadCard[] = [
  { name: 'Le Soleil', emoji: '', meaning: 'Joie, clarté et épanouissement. Une énergie lumineuse et sans ambiguïté traverse cette dimension de votre situation.' },
  ...
  { name: 'L\'Empereur', emoji: '', meaning: 'Structure et engagement. Le besoin de stabilité et de cadre clair domine ici, parfois au prix de la spontanéité.' },
  ...
  { name: 'La Justice', emoji: '', meaning: 'Équilibre et vérité. Une clarification honnête, parfois inconfortable, s\'impose dans cette dimension.' },
  ...
  { name: 'L\'Hermite', emoji: '', meaning: 'Introspection nécessaire. Cette dimension demande du recul et de la solitude choisie avant toute décision.' },
