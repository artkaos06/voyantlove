...
export const ORACLE_DECK: OracleCard[] = [
  { name: 'Le Cœur', emoji: '', message: 'Un sentiment sincère est au centre de votre question. L\'amour présent est réel, laissez-le s\'exprimer sans crainte.' },
  ...
  { name: 'Le Soleil', emoji: '', message: 'Clarté et joie. Ce que vous viviez dans l\'incertitude devient enfin lumineux et évident.' },
  ...
  { name: 'Le Chemin', emoji: '', message: 'Un choix se présente. Deux directions s\'offrent à vous, l\'une demande du courage, l\'autre de la patience.' },
  { name: 'La Maison', emoji: '', message: 'Foyer et vie commune. Cette carte évoque la construction d\'un cadre de vie partagé.' },
  { name: 'Les Oiseaux', emoji: '', message: 'Dialogue et échange. Une conversation à deux clarifiera ce qui reste flou entre vous.' },
  ...
  { name: 'Les Nuages', emoji: '', message: 'Confusion passagère. Le trouble actuel se dissipera, évitez les décisions hâtives en attendant.' },
