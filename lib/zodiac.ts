...
export const ZODIAC_SIGNS: ZodiacSign[] = [
  { name: 'Bélier', emoji: '♈︎', element: 'Feu', range: [3, 21, 4, 19] },
  { name: 'Taureau', emoji: '♉︎', element: 'Terre', range: [4, 20, 5, 20] },
  { name: 'Gémeaux', emoji: '♊︎', element: 'Air', range: [5, 21, 6, 20] },
  { name: 'Cancer', emoji: '♋︎', element: 'Eau', range: [6, 21, 7, 22] },
  { name: 'Lion', emoji: '♌︎', element: 'Feu', range: [7, 23, 8, 22] },
  { name: 'Vierge', emoji: '♍︎', element: 'Terre', range: [8, 23, 9, 22] },
  { name: 'Balance', emoji: '♎︎', element: 'Air', range: [9, 23, 10, 22] },
  { name: 'Scorpion', emoji: '♏︎', element: 'Eau', range: [10, 23, 11, 21] },
  { name: 'Sagittaire', emoji: '♐︎', element: 'Feu', range: [11, 22, 12, 21] },
  { name: 'Capricorne', emoji: '♑︎', element: 'Terre', range: [12, 22, 1, 19] },
  { name: 'Verseau', emoji: '♒︎', element: 'Air', range: [1, 20, 2, 18] },
  { name: 'Poissons', emoji: '♓︎', element: 'Eau', range: [2, 19, 3, 20] },
];
