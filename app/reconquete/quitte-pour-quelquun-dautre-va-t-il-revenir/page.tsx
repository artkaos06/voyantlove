  ...
  return (
    <ContentPage config={config}>
        ...
        <section className="bg-white rounded-xl shadow-md p-8 mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">{'️'} Partir pour Quelqu&apos;un d&apos;Autre ne Révèle Pas Toute l&apos;Histoire</h2>
        ...
        <section id="possible" className="bg-gradient-to-br from-violet-50 to-fuchsia-50 rounded-xl p-8 mb-8 border-2 border-violet-200">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">{''} Ce qui est Possible, ce qui Reste Imprévisible</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg p-6 border-l-4 border-green-500">
              <h3 className="font-bold text-lg mb-3 text-green-700">Facteurs qui Peuvent Jouer</h3>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-gray-400">
              <h3 className="font-bold text-lg mb-3 text-gray-700">Ce que Personne ne Peut Prédire</h3>
              <ul className="space-y-2 text-gray-700 text-sm">
          ...
          <div className="mt-6 bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded">
            <p className="text-gray-700"><strong>À retenir :</strong> aucune de ces éventualités ne justifie de mettre votre vie en pause. Le possible n&apos;est pas le probable, et l&apos;espoir sain se construit à côté de votre reconstruction, jamais à sa place.</p>
          </div>
        </section>

        {/* H2: Signes concrets vs faux signes */}
        <section className="bg-white rounded-xl shadow-md p-8 mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Les Signes Concrets d&apos;un Retour et les Faux Signaux</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-orange-50 border-2 border-orange-300 rounded-lg p-6">
              <h3 className="font-bold text-lg mb-3 text-orange-700">{'️'} Faux Signaux</h3>
              <ul className="space-y-2 text-gray-700 text-sm">
        ...
        <section id="identite" className="bg-gradient-to-r from-fuchsia-50 to-rose-50 rounded-xl p-8 mb-8 border-2 border-fuchsia-200">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Retrouver son Identité Après une Relation Longue</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 border-l-4 border-fuchsia-500">
              <h3 className="font-bold text-lg mb-2 text-fuchsia-700">Renouer avec ce qui est à vous</h3>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-rose-500">
              <h3 className="font-bold text-lg mb-2 text-rose-700">Cesser la surveillance</h3>
            ...
            <div className="bg-white rounded-lg p-6 border-l-4 border-purple-500">
              <h3 className="font-bold text-lg mb-2 text-purple-700">Avancer à votre rythme</h3>
          ...
          <div className="mt-6 bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded">
            <p className="text-gray-700"><strong>À retenir :</strong> si une seconde chance devait un jour se présenter, elle ne serait saine qu&apos;à certaines conditions, reconnaissance des causes, changements réels, respect retrouvé. Notre guidance sur la <Link href="/reconquete/seconde-chance-amour/" className="text-purple-600 hover:text-purple-800 underline font-medium">seconde chance en amour</Link> explore ce qu&apos;il faut vérifier avant de rouvrir cette porte.</p>
          </div>
        </section>
