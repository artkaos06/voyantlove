    ...
    <ContentPage config={config}>
        ...
        <section id="signes" className="bg-white rounded-xl shadow-md p-8 mb-8">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-green-50 rounded"><div className="text-2xl">1️⃣</div><p className="text-gray-700"><strong>Contact repris</strong> : Votre ex vous <Link href="/reconquete/ex-revient-silence-radio/" className="text-violet-600 hover:text-violet-800 font-medium">recontacte après une période de silence</Link>, souvent avec un prétexte anodin comme récupérer un objet ou poser une question pratique. Ce premier message est rarement innocent : il teste votre réceptivité et jauge votre réaction émotionnelle avant d'aller plus loin.</p></div>
        ...
        <section className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700">Ne brûlez pas les étapes. Après le premier contact, <strong>reconstruisez la complicité</strong> graduellement : d'abord des échanges de messages, puis un café, puis une sortie. Si les signaux sont positifs, notre guide pour <Link href="/reconquete/se-remettre-ensemble/" className="text-violet-600 hover:text-violet-800 font-medium">se remettre ensemble</Link> détaille chaque phase de la reconstruction. La précipitation est l'ennemi numéro un des retrouvailles réussies. L'ensemble de cette démarche s'inscrit dans un parcours complet de <Link href="/reconquete/" className="text-violet-600 hover:text-violet-800 font-medium">retrouvailles</Link> que le tarot peut éclairer à chaque étape.</p>
            </div>
          </div>
        </section>
