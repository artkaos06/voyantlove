        ...
        <section className="bg-white rounded-xl shadow-md p-8 mb-8 border-t-4 border-fuchsia-500">
          ...
          <div className="space-y-4">
            <div className="bg-fuchsia-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700">Cette première carte permet d'interpréter ce que votre ex ressent <strong>en ce moment précis</strong> à votre égard. Elle distingue l'amour sincère de la simple nostalgie, l'attachement profond de l'habitude. Les arcanes comme Le Deux de Coupes ou L'Impératrice signalent un amour toujours vivant, tandis que le Cinq de Coupes ou le Quatre de Coupes suggèrent un détachement en cours.</p>
            </div>
            <div className="bg-fuchsia-50 p-4 rounded-lg">
