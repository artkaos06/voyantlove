...
const config: ContentPageConfig = {
  ...
  faq: [
    {
      q: 'Combien de temps dure un chagrin d\'amour ?',
      a: 'La durée d\'un chagrin d\'amour varie considérablement d\'une personne à l\'autre, mais la moyenne se situe entre 3 et 6 mois pour une relation significative. Plusieurs facteurs influencent cette durée : la longueur de la relation, l\'intensité de l\'attachement émotionnel, les circonstances de la séparation et votre propre capacité de résilience. Le tarot peut révéler votre timeline personnelle de guérison en identifiant les blocages énergétiques qui ralentissent le processus. L\'important n\'est pas la vitesse de guérison, mais sa profondeur. Une guérison trop rapide en surface cache souvent des blessures non traitées qui resurgiront dans vos futures relations.',
    },
    {
      q: 'Comment savoir si je suis guéri(e) ?',
      a: 'Plusieurs signes concrets indiquent que votre guérison émotionnelle est complète. Vous pensez rarement à votre ex, et lorsque cela arrive, les souvenirs ne provoquent plus de douleur vive mais une nostalgie douce et détachée. Vous ressentez de la curiosité pour de nouvelles rencontres, vous avez retrouvé votre joie de vivre indépendamment de toute relation, et vous pouvez sincèrement souhaiter du bonheur à votre ex sans amertume. Le tarot confirme cette ouverture émotionnelle avec l\'apparition de cartes comme L\'Étoile ou l\'As de Coupe dans vos tirages. La guérison complète signifie aussi ne plus comparer chaque nouvelle personne à votre ancien partenaire.',
    },
    {
      q: 'Normal d\'avoir mal des mois après une rupture ?',
      a: 'Oui, il est tout à fait normal de ressentir encore de la douleur plusieurs mois après une rupture, surtout lorsqu\'il s\'agissait d\'une relation longue ou particulièrement intense. Le processus de deuil amoureux n\'est pas linéaire et comporte souvent des rechutes temporaires, même après des périodes d\'amélioration. Certaines dates anniversaires, certains lieux ou certaines chansons peuvent raviver momentanément la souffrance. Si après 12 mois la douleur reste aussi vive qu\'au premier jour et empêche votre fonctionnement quotidien, il est recommandé de consulter un thérapeute professionnel en complément d\'un accompagnement par le tarot. L\'un n\'exclut pas l\'autre : la voyance éclaire le chemin spirituel tandis que la thérapie traite les mécanismes émotionnels profonds.',
    },
    {
      q: 'La voyance accélère-t-elle la guérison ?',
      a: 'La voyance peut effectivement accélérer le processus de guérison émotionnelle de plusieurs façons complémentaires. Elle apporte d\'abord la clarté sur le « pourquoi » de la rupture, ce qui facilite l\'acceptation intellectuelle et émotionnelle. Ensuite, elle offre une rassurance sur le « quand », en identifiant les périodes propices à la reconstruction. Enfin, elle fournit une guidance concrète sur les actions à entreprendre pour avancer. La compréhension spirituelle de votre situation, notamment à travers les arcanes du tarot et les transits astrologiques, permet de donner un sens à la souffrance et de la transformer en croissance personnelle. Beaucoup de consultants témoignent d\'un soulagement significatif dès la première consultation.',
    },
  ],
  related: [
