    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section id="signes" className="bg-white rounded-xl shadow-md p-8 mb-8">
          ...
          <p className="text-gray-700 mb-6">
            Reconnaître votre <strong>flamme jumelle</strong> demande de savoir interpréter les signaux spirituels et énergétiques. Voici les 11 signes les plus fiables identifiés par la <strong>voyance karmique</strong> et confirmés par des milliers de consultations.
          </p>
