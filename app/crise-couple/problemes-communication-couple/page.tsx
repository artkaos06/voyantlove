    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <article className="bg-white rounded-xl shadow-md p-8 mb-8 border-t-4 border-purple-600">
          ...
          <p className="text-lg leading-relaxed mb-4">
            Le <strong>tarot relationnel</strong> permet de décrypter les <strong>blocages énergétiques</strong> qui empêchent la vraie connexion, d'interpréter les <strong>blessures non guéries</strong> qui créent des schémas de communication toxiques, et de révéler les <strong>peurs inconscientes</strong> qui font que vous et votre partenaire ne vous entendez plus. Plus qu'un simple diagnostic, la voyance offre des solutions concrètes pour <strong>reconstruire le dialogue</strong> et retrouver l'intimité émotionnelle.
          </p>
