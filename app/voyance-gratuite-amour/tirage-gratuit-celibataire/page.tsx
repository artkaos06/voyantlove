    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div><div className="text-2xl font-bold text-rose-600">3 tirages</div><div className="text-sm text-gray-600">Sp&eacute;cifiques c&eacute;libataires</div></div>
          <div><div className="text-2xl font-bold text-rose-600">Fiable</div><div className="text-sm text-gray-600">Guidance sentimentale</div></div>
          <div><div className="text-2xl font-bold text-rose-600">22 arcanes</div><div className="text-sm text-gray-600">R&eacute;v&eacute;lateurs</div></div>
          <div><div className="text-2xl font-bold text-rose-600">Personnalis&eacute;</div><div className="text-sm text-gray-600">Adapt&eacute; &agrave; votre profil</div></div>
        </div>
