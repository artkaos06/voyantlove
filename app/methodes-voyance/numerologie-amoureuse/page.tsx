    ...
    <ContentPage config={config}>
        ...
        <section id="calcul" className="bg-white rounded-xl shadow-md p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {LIFE_PATH_MEANINGS.map(({ num, title, desc }) => (
        ...
        <section id="prenom" className="bg-white rounded-xl shadow-md p-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {EXPRESSION_MEANINGS.map(({ num, desc }) => (
          ...
          <div className="space-y-4 mt-6">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {INTIMATE_MEANINGS.map(({ num, desc }) => (
        ...
        <VoyantQuickCTA topic="methodes-voyance" source="numerologie-amoureuse-banner-mid" />
