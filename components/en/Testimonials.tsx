...
const TESTIMONIALS: Testimonial[] = [
  {
    ...
    outcome: 'He texted me 9 days later.',
    source: 'Paraphrased from a recent 5-star review on Briaz’s Keen profile',
    initialBgClass: 'from-rose-400 to-pink-500',
  },
  {
    name: 'Maria',
    meta: '28 · Southwest US',
    quote:
      'I was completely skeptical going in. She described things about my ex she couldn’t have known. The 5-minute trial sold me — I stayed on for another 20.',
    outcome: 'I’ve been a regular ever since.',
    source: 'Paraphrased from a recent review on Keen’s Love & Relationships category',
    initialBgClass: 'from-purple-400 to-indigo-500',
  },
  {
    name: 'Jenna',
    meta: '35 · Midwest',
    quote:
      'She told me he was confused, not over me. The advisor was honest about what she saw and what she didn’t — no false promises, just clarity.',
    outcome: 'Three weeks later he asked to meet.',
